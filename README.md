...
- ✨ **AI 默认开启**：首次安装即自动分类新书签，无需先去设置中开启
- ✨ **自定义 AI 服务地址**：支持配置任意 OpenAI 兼容的 Base URL，可对接 DeepSeek / 智谱 / 本地模型等
- ✨ **Popup 标签推荐**：新建书签时即时显示 AI 推荐标签，可一键增删
- 🐛 **修复 AI 打标签的稳定性问题**：解决部分场景下标签写入失败、闭包过期等异常
- 💎 **界面视觉优化**：侧边栏 Logo 与文字对齐、弹窗 / 头部 / 标签等多处样式打磨
- 🌐 **i18n 完善**：AI Prompt 按 UI 语言（中 / 英）动态切换，新增大量翻译条目
